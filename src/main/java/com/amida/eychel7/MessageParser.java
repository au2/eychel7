...
public class MessageParser {
	...
	public static void parse(String[] args) {
		 ...
		 * components1, so we will cast it as such. The ADT_A01 class extends from
		 * Message, providing specialized accessors for ADT^A01's segments.
		 * 
		 * HAPI provides several versions of the ADT_A01 class, each in a different
		 * package (note the import statement above) corresponding to the HL7 version
		 * for the message.
		 */
		 ...
		 * 
		 * PN is an HL7 data type consisting of several components, such as family name,
		 * given name, etc.
		 */
