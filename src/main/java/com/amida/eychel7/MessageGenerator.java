...
public class MessageGenerator {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * <MSH> <MSH.1>|</MSH.1> <MSH.2>^~\&amp;</MSH.2> <MSH.3>
		 * <HD.1>TestSendingSystem</HD.1> </MSH.3> <MSH.7> <TS.1>200701011539</TS.1>
		 * </MSH.7> <MSH.9> <MSG.1>ADT</MSG.1> <MSG.2>A01</MSG.2> <MSG.3>ADT A01</MSG.3>
		 * </MSH.9> <MSH.13>123</MSH.13> </MSH> <PID> <PID.3> <CX.1>123456</CX.1>
		 * </PID.3> <PID.5> <XPN.1> <FN.1>Doe</FN.1> </XPN.1> <XPN.2>John</XPN.2>
		 * </PID.5> </PID> </ADT_A01>
		 */
